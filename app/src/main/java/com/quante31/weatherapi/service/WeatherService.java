...
public class WeatherService implements WeatherMethods{
	...
	@Override
	public String getWeather(double d, double e, String apiKey, String units) throws URISyntaxException, IOException, InterruptedException {
		HttpRequest.Builder requestBuilder = new HttpWeatherRequestBuilder(new URI("https://api.openweathermap.org/data/2.5/weather?lat=" + d + "&lon="+ e +"&appid=" + apiKey + "&units=" + units)).getRequestBuilder();
		requestBuilder.GET();
